...
@pytest.mark.parametrize(
    "n,expected",
    [
        (409, (41, 41, 41, 41, 41, 41, 41, 41, 41, 40)),
...
def test_all_four_support_clauses_are_required(cfg003):
    ...
    assert _decide(cfg003, strategy_sharpe=0.40).verdict != "SUPPORTED"
...
def test_failing_to_beat_the_benchmark_at_all_abandons(cfg003):
    ...
    assert _decide(cfg003, benchmark_sharpe=0.70).verdict == "ABANDON"
